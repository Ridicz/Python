...
class TestTriangle(unittest.TestCase):
    ...
    def test_init(self):
        self.assertRaises(ValueError, Triangle, "String", 1, 1, 1, 1, 1)
    ...
    def test_move(self):
        ...
        with self.assertRaises(ValueError):
            Triangle.move(Triangle(1, 1, 1, 1, 1, 1), 0, "String")
